...
import { Settings, Sync, Database, Shield } from 'lucide-react';
...
export default function PreferencesDemo({ className = '' }: PreferencesDemoProps) {
  ...
  return (
    <div className={`preferences-demo ${className}`}>
      {/* Demo Header */}
      <div className="text-center mb-8"></div>    <h2 className="text-3xl md:text-4xl font-black font-mono uppercase tracking-wider mb-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="p-4 border-3 border-foreground bg-background text-center">
          <Sync size={32} className="mx-auto text-brutalist-yellow mb-3" />
          <h3 className="font-mono font-bold text-sm uppercase tracking-wider mb-2">
            Auto Sync
          </h3>
          <p className="text-xs font-mono text-foreground/60">
      ...
      <div className="mt-8 p-6 bg-foreground/5 border-2 border-foreground/20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
          <button
            onClick={() => {
              // This would trigger a preference update
          ...
          <button
            onClick={() => {
              // This would trigger a theme change
